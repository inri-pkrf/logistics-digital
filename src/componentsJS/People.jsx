...
import '../componentsCSS/People.css';
...
function People() {
    ...
    const points = [
        { title: "בתיק הנתונים", text: `החזקה בתיק נתונים המכיל – שבצ"ק – תקן מצבה, הכשרות והיתרים נדרשים עבור החיילים, חוגרים בתפקיד מפקדים, נתוני החיילים ועוד.`},
        ...
        { title: "מקצועות קריטיים", text: `ניתוח המקצועות הקריטיים בפלוגה והגדרת קוים אדומים לרציפות תפקודית המשפיעים על כשירות הפלוגה – נהגים, טנ"א, צמ"ה, שדרה פיקודית ועוד.` },
        ...
        { title: "דגשים לאיוש וגריעה", text: `מינוי בע"ת לוגיסטיים או גריעה והורדה מהשורה ייעשו בתיאום אל מול מפקד המסגרת הלוגיסטית ברמה הממונה ובאישור רע"ן לוגיסטיקה פיקוד בלבד! אין אפשרות לבצע שינוי בשורות כ"א ללא ביצוע תאום, זאת כדי לוודא מינוי אנשים מתאימים וכדי למנוע "בריחת" בע"ת מחוץ ליחידה.`}
    ];
        ...
        <div className="People">
            <div className='white-circle-People'>
                ...
                <p className='txt-People'>   
                    ...
                    לאור כך, על מפקד המסגרת הלוגיסטית בנפה/חטיבת מילואים/בגדוד לעסוק במהלך <b>השגרה</b> באופן שוטף <b>בבניין הכוח</b>, <b>להפעלת הכח בחירום</b> בכדי לבנות יכולת מקסימלית.
                </p>
