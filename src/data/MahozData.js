...
`,
...

    {
        ...
        taskNote: [
            <>
            1. לאשר את תמונת המצב הלוגיסטית במרחב המחוז.<br/><br/>
            2. קיום הע"מ מתמשכת ורציפה והעברת משמעויות למערכים, מפקדות, ציר התכנון והפעלת הכח.<br/><br/>
            3. מימוש הפקודה הלוגיסטית היומית.<br/><br/>
            4. מתן מענה לדרישות ולצרכים בלתי מתוכננים העולים במהלך הלחימה.<br/><br/>
            5. המלצה על הסטת מרכזי כובד לוגיסטיים מחוזיים לאור העערכת מצב מתמשכת.<br/><br/>
            6. אחראי לביצוע הערכות מצב מפקד המלכ"א והערכות מצב עיתיות.<br/><br/>
